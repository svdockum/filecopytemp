...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221222_toktoktok_005655229a39b9de9779_20221222112401_archive.zip';
        const ARCHIVE_SIZE       = '87305985';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '0056552-22112401';
        const SECONDARY_PACKAGE_HASH = 'eaa4680-22112401';
        const VERSION            = '1.5.1';
